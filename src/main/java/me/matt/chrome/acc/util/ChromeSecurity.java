...
public class ChromeSecurity {
	...
	public static String getOSXKeychainPasswordAsAdmin(String host) {
		try {
			/*
			 * May require admin password for pc? Looking for workaround, but keychain seems
			 * pretty secure ATM (perhaps I can spoof being google chrome and load their
			 * keychain auth? Is this something done locally?
			 *
